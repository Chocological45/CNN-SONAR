...
EPOCHS = 20             # Number of training runs
BATCH_SIZE = 10
IMG_WIDTH = 96
IMG_HEIGHT = 96
        ...
        if os.path.isdir(path):
            ...
            for data in os.listdir(path):
                ...
                if data != '.DS_Store':
                    ...
                    reshaped = edges.reshape(IMG_WIDTH, IMG_HEIGHT, 1)
...
def get_model():
    model = tf.keras.models.Sequential([
        ...
        tf.keras.layers.Conv2D(
            32, (3, 3), activation='sigmoid', padding='valid', input_shape=(IMG_WIDTH, IMG_HEIGHT, 1)
        ),
